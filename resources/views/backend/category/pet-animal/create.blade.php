@extends('master')
@section('title', 'Create | Pet Animal')
@section('ads','active') @section('ads_show','show') @section('pet_animal','active') @section('pet_animal_show','show') @section('pet_animal_create','active')
@section('content')
{!! Form::open(['class' =>'form-sample','route' => 'pet-animal.store','method' => 'POST','enctype' => 'multipart/form-data']) !!}
<div class="row">
    <div class="col-md-3"></div>
    <div class="col-md-6">
        <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-success text-white mr-2"><i class="mdi mdi-paperclip"></i></span> Add New Pet Animal</h3></div>
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="email">Item of Animal</label>
