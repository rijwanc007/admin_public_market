@extends('master')
@section('title', 'Show | Pet Animal')
@section('ads','active') @section('ads_show','show') @section('pet_animal','active') @section('pet_animal_show','show')
@section('content')
    <div class="container">
        <h2 class="text-center text-info">
            Pet & Animal Ads Information
