@extends('master')
@section('title', 'Show | Tour Travel')
@section('ads','active') @section('ads_show','show') @section('tour_travel','active') @section('tour_travel_show','show')
@section('content')
    <div class="container">
        <h2 class="text-center text-info">
            Tour & Travel Ads Information
