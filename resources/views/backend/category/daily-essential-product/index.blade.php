@extends('master')
@section('title', 'Index | Daily Essential Product')
@section('ads','active') @section('ads_show','show') @section('daily_essential_product','active') @section('daily_essential_product_show','show') @section('daily_essential_product_index','active')
@section('content')
    <div class="card">
        <div class="card-body">
            {!! Form::open(['class' =>'form-sample','route' => ['daily-essential-product.find'],'method' => 'GET']) !!}
            <div class="row">
                <div class="col-sm-4">
            ...
            {!! Form::close() !!}
            {!! Form::open(['route' => 'daily-essential-product.search','method' => 'GET']) !!}
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row table-responsive">
                        <div class="col-md-12">
                            <h2 class="text-center custom_text_design">All Daily Essential Product Ads<hr style=""/></h2>
                            ...
                            <table class="custom">
                                ...
                                @forelse($allAds as $Ads)
                                    <tr class="text-center">
                                        ...
                                        <td> {{$Ads->price}} </td>
                                        <td>
                                            <button type="button" class="btn-floating btn-inverse-success btn-icon" onclick="window.location='{{route('daily-essential-product.show',$Ads->id)}}'"><i class="mdi mdi-eye"></i></button>
                                            @if($Ads->approve == 0)
                                                <button type="button" class="btn-floating btn-inverse-info btn-icon btn_approve" onclick="window.location='{{route('daily-essential-product.approve',$Ads->id)}}'"><i class="mdi mdi-check"></i></button>
                                            @else
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open(['route' => ['daily-essential-product.destroy',$Ads->id],'method' => 'DELETE']) !!}
