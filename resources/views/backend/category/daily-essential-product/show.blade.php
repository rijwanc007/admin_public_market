...
@section('ads','active') @section('ads_show','show') @section('daily_essential_product','active') @section('daily_essential_product_show','show')
@section('content')
    <div class="container">
        <h2 class="text-center text-info">
            Daily Essential Product Ads Information
