@extends('master')
@section('title', 'Index | Others')
@section('ads','active') @section('ads_show','show') @section('others','active') @section('others_show','show') @section('others_index','active')
@section('content')
    <div class="card">
        <div class="card-body">
            {!! Form::open(['class' =>'form-sample','route' => ['others.find'],'method' => 'GET']) !!}
            <div class="row">
                <div class="col-sm-4">
            ...
            {!! Form::close() !!}
            {!! Form::open(['route' => 'others.search','method' => 'GET']) !!}
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row table-responsive">
                        <div class="col-md-12">
                            <h2 class="text-center custom_text_design">All Others Ads<hr style=""/></h2>
                            ...
                            <table class="custom">
                                ...
                                @forelse($allAds as $Ads)
                                    <tr class="text-center">
                                        ...
                                        <td> {{$Ads->price}} </td>
                                        <td>
                                            <button type="button" class="btn-floating btn-inverse-success btn-icon" onclick="window.location='{{route('others.show',$Ads->id)}}'"><i class="mdi mdi-eye"></i></button>
                                            @if($Ads->approve == 0)
                                                <button type="button" class="btn-floating btn-inverse-info btn-icon btn_approve" onclick="window.location='{{route('others.approve',$Ads->id)}}'"><i class="mdi mdi-check"></i></button>
                                            @else
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open(['route' => ['others.destroy',$Ads->id],'method' => 'DELETE']) !!}
