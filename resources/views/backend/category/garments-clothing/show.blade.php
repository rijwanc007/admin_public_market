...
@section('ads','active') @section('ads_show','show') @section('garments_clothing','active') @section('garments_clothing_show','show')
@section('content')
    <div class="container">
        <h2 class="text-center text-info">
            Garments & Cloths Ads Information
