...
@section('ads','active') @section('ads_show','show') @section('garments_clothing','active') @section('garments_clothing_show','show') @section('garments_clothing_create','active')
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => 'garments-clothing.store','method' => 'POST','enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-success text-white mr-2"><i class="mdi mdi-paperclip"></i></span> Add New Garments & Clothing</h3></div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="email">Item Size</label>
                        <input type="text" class="form-control" id="item_size" name="item_size" placeholder="Enter Item Size" >
                    </div>
                    <div class="form-group">
