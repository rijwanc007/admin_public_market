...
@section('ads','active') @section('ads_show','show') @section('fuel_oil_gas','active') @section('fuel_oil_gas_show','show') @section('fuel_oil_gas_create','active')
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => 'fuel-oil-gas.store','method' => 'POST','enctype' => 'multipart/form-data']) !!}
    <div class="row">
