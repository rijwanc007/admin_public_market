@extends('master')
@section('title', 'Show | Rent To Let')
@section('ads','active') @section('ads_show','show') @section('rent_to_let','active') @section('rent_to_let_show','show')
@section('content')
    <div class="container">
        <h2 class="text-center text-info">
            Rent/To-Let Ads Information
