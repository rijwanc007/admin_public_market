@extends('master')
@section('title', 'Create | Resort Hotel & Community Center')
@section('ads','active') @section('ads_show','show') @section('resort_hotel_community_center','active') @section('resort_hotel_community_center_show','show') @section('resort_hotel_community_center_create','active')
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => 'resort-hotel-community-center.store','method' => 'POST','enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-success text-white mr-2"><i class="mdi mdi-paperclip"></i></span> Add Resort Hotel Community Center</h3></div>
            <div class="card">
                <div class="card-body">
