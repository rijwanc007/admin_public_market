@extends('master')
@section('title', 'Show | PM Food Bank & Restaurant')
@section('ads','active') @section('ads_show','show') @section('pm_food_bank_restaurant','active') @section('pm_food_bank_restaurant_show','show')
@section('content')
    <div class="container">
        <h2 class="text-center text-info">
            PM Food Bank & Restaurants Ads Information
