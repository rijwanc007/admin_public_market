...
@section('ads','active') @section('ads_show','show') @section('business_industry','active') @section('business_industry_show','show') @section('business_industry_create','active')
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => 'business-industry.store','method' => 'POST','enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-success text-white mr-2"><i class="mdi mdi-paperclip"></i></span> Add New Business & Industry</h3></div>
            <div class="card">
                <div class="card-body">
