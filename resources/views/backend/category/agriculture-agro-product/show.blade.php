...
@section('ads','active') @section('ads_show','show') @section('agriculture_Agro_Product','active') @section('agriculture_Agro_Product_show','show')
@section('content')
    <div class="container">
        <h2 class="text-center text-info">
            Agriculture & Agro Ads Information
