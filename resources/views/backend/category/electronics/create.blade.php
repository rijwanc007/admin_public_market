...
@section('ads','active') @section('ads_show','show') @section('electronic','active') @section('electronic_show','show') @section('electronic_create','active')
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => 'electronic.store','method' => 'POST','enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-success text-white mr-2"><i class="mdi mdi-paperclip"></i></span> Add New Electronics</h3></div>
            <div class="card">
                <div class="card-body">
