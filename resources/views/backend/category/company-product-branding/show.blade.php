...
@section('ads','active') @section('ads_show','show') @section('company_product_branding','active') @section('company_product_branding_show','show')
@section('content')
    <div class="container">
        <h2 class="text-center text-info">
            Company Product Branding Ads Information
