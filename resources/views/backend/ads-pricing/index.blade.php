...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            {!! Form::close() !!}
            {!! Form::open(['route' => 'ads-pricing.search','method' => 'GET']) !!}
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row table-responsive">
                        <div class="col-md-12">
                            <h2 class="text-center custom_text_design">All Ads Pricing Ads<hr style=""/></h2>
                            ...
                            <table class="custom">
                                ...
                                @forelse($allAds as $Ads)
                                    <tr class="text-center">
                                        ...
                                        <td> {{Str::limit($Ads->description, 15)}}</td>
                                        <td>
                                            <button type="button" class="btn-floating btn-inverse-success btn-icon" onclick="window.location='{{route('ads-pricing.show',$Ads->id)}}'"><i class="mdi mdi-eye"></i></button>
                                            <button type="button" class="btn-floating btn-inverse-success btn-icon" onclick="window.location='{{route('ads-pricing.edit',$Ads->id)}}'"><i class="mdi mdi-pencil"></i></button>
                                            @if($Ads->approve == 0)
                                                <button type="button" class="btn-floating btn-inverse-info btn-icon btn_approve" onclick="window.location='{{route('ads-pricing.approve',$Ads->id)}}'"><i class="mdi mdi-check"></i></button>
                                            @else
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Delete Ads Pricing</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <p>Are You Want To Delete Ads Pricing.</p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                            {!! Form::open(['route' => ['ads-pricing.destroy',$Ads->id],'method' => 'DELETE']) !!}
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-info">{{'No Ads Pricing Created Yet'}}</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
