@extends('master')
@section('title', 'Index | TVC')
@section('tvc','active') @section('tvc_show','show') @section('tvc_index','active')
@section('content')
    <div class="card">
        <div class="card-body">
            {!! Form::open(['class' =>'form-sample','route' => ['tvc.find'],'method' => 'GET']) !!}
            <div class="row">
                <div class="col-sm-4">
            ...
            {!! Form::close() !!}
            {!! Form::open(['route' => 'tvc.search','method' => 'GET']) !!}
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row table-responsive">
                        <div class="col-md-12">
                            <h2 class="text-center custom_text_design">All Tvc Ads<hr style=""/></h2>
                            ...
                            <table class="custom">
                                ...
                                @forelse($allAds as $Ads)
                                    <tr class="text-center">
                                        ...
                                        <td> {{Str::limit($Ads->tvc_title, 20)}}</td>
                                        <td>
                                            ...
                                            @if($Ads->approve == 0)
                                                <button type="button" class="btn-floating btn-inverse-info btn-icon btn_margin" onclick="window.location='{{route('tvc.approve',$Ads->id)}}'"><i class="mdi mdi-check"></i></button>
                                            @else
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Delete Tvc</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <p>Are You Want To Delete Tvc.</p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                            {!! Form::open(['route' => ['tvc.destroy',$Ads->id],'method' => 'DELETE']) !!}
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-info">{{'No Tvc Created Yet'}}</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
