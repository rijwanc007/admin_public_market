...
class CreateGarmentsClothingTable extends Migration
{

    public function up()
    {
        Schema::create('garments_clothing', function (Blueprint $table) {
            ...
            $table->string('item_size')->default(0)->nullable();
    ...
    {
        Schema::dropIfExists('garments_clothing');
    }
}
