...
class CreatePmFoodBankRestaurantsTable extends Migration
{

    public function up()
    {
        Schema::create('pm_food_bank_restaurants', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pm_food_bank_restaurants');
    }
}
