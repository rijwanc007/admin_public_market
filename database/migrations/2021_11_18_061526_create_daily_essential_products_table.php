...
class CreateDailyEssentialProductsTable extends Migration
{

    public function up()
    {
        Schema::create('daily_essential_products', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('daily_essential_products');
    }
}
