...
class CreateVehicleTransportationsTable extends Migration
{

    public function up()
    {
        Schema::create('vehicle_transportations', function (Blueprint $table) {
            ...
            $table->string('edition')->default(0)->nullable();
            $table->string('year_of_manufacture')->default(0)->nullable();
            $table->string('kilometers_run')->default(0)->nullable();
            $table->string('engine_capacity')->default(0)->nullable();
            $table->string('segment')->default(0)->nullable();
            $table->string('wheel_size')->default(0)->nullable();
            $table->string('color')->default(0)->nullable();
            $table->string('item_type')->default(0)->nullable();
    ...
    {
        Schema::dropIfExists('vehicle_transportations');
    }
}
