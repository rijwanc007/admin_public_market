...
class CreateCompanyProductBrandingsTable extends Migration
{

    public function up()
    {
        Schema::create('company_product_brandings', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('company_product_brandings');
    }
}
