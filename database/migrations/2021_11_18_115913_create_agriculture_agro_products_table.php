...
class CreateAgricultureAgroProductsTable extends Migration
{

    public function up()
    {
        Schema::create('agriculture_agro_products', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('agriculture_agro_products');
    }
}
